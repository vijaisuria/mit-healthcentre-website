...
<body>
    ...
    <main>
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="about-caption mb-50">
                            ...
                            <div class="section-tittle section-tittle2 mb-35">
                                <span>MIT HEALTH CENTER</span>
                                <p>
                                    <strong class="H-font">H</strong>ealth Centre is committed to promoting the health
                                    and
                                    wellness of the campus
                                    community
                                    by providing high-quality
                                    prevention, education, and treatment services. The medical, counseling, and health
                                    promotion services are designed to
                                    help you stay healthy or get better so that you can minimize disruptions caused by
                                    injury and illness. The Health Centre
                                    aims to enhance the healthcare experience of the MIT campus community by providing
                                    healthcare with respect,
                                    consideration and confidentiality. Please review this website or reach out to the
                                    Heath
                                    Centre staff for details of
                                    healthcare resources, prevention methods, health education and general healthcare
                                    guidance.
                                </p>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item about-image active">
                                    <img class="d-block w-100" src="assets/img/gallery/mit-admin.png" alt="First slide">
                                </div>
                                <div class="carousel-item about-image">
                                    <img class="d-block w-100" src="assets/img/gallery/mit-annexe.jpg"
                                        alt="Second slide">
                                </div>
                                <div class="carousel-item about-image">
                                    <img class="d-block w-100" src="assets/img/gallery/mit-main.jpg" alt="Third slide">
                                </div>
                            </div>
        ...
        <div class="whole-wrap section-padding1">
            <div class="container box_1170">
                <div class="section-top-border">
                    <div class="row">
                        <div class="col-md-3">
                            <img src="assets/img/logo/mit-hc-logo.png" alt="" class="img-fluid">
                        </div>
                        <div class="col-md-9 mt-sm-20">
                            <h1>Overview</h1>
                            <p>Health Centre facility with attached inpatient ward is available at MIT campus. It is
                                located in the Hostel zone for the
                                convenience of hostellers.</p>
                            <h1>Vision</h1>
                            <p>Continue to provide exemplary physical and emotional care for reach of our students,
                                staff members and their families.
                                Ensure healthy atmosphere of the entire campus communitythrough incomparable patient
                                care, free treatment andwellness
                                programs.</p>
                        </div>
                    </div>
                </div>

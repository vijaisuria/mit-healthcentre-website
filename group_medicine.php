               ...
               <div class="col-lg-8 posts-list">
                  <div class="single-post">
                     ...
                     <div class="blog_details">
                        ...
                        <ol class="ordered-list">
                           <li>Eligible for Rs.50,000/- for medical treatment (Mediclaim policy) for every student.</li>
                           <li>Room, boarding, nurses expenses must be eligible.</li>
                           <li>I.C.U. Ambulance, other surgeon fees must be eligible.</li>
                           <li>Cashless treatment in networked hospitals.</li>
                  ...
                  <div class="navigation-top">
                     <div class="d-sm-flex justify-content-between text-center">
                        <p class="like-info"><span class="align-middle"><i class="fa fa-share"></i></span> Share the
                           info</p>
                     ...
                     <div class="single-footer-caption mb-50">
                        <div class="footer-tittle">
                           ...
                           <div class="footer-pera">
                              <p class="info1">Lorem igpsum doldfor sit amet, adipiscing elit, sed do eiusmod tempor
                                 cergelit rgh. </p>
